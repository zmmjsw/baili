...
public class ShiroConfig {
	 ...
	 * @return
	 */
	private ShiroRedisCacheManager cacheManager(@SuppressWarnings("rawtypes") RedisTemplate template) {
		return new ShiroRedisCacheManager(template);
	}

	@Bean
	public SecurityManager securityManager(@SuppressWarnings("rawtypes") RedisTemplate redisTemplate) {
