...
Date: 2018-12-06 16:46:13
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for b_attribute_key
-- ----------------------------
DROP TABLE IF EXISTS `b_attribute_key`;
CREATE TABLE `b_attribute_key` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `category_id` bigint(20) DEFAULT NULL,
  `attribute_name` varchar(25) DEFAULT NULL,
  `name_seq` int(9) DEFAULT NULL,
