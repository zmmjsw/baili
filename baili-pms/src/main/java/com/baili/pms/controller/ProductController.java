...
public class ProductController {
	...
	public ResponseVo<Void> addProduct(@Valid@RequestBody Product product) {
	...
	public ResponseVo<Void> deleteProduct(@NonNull@RequestParam(value = "id") Long id) {
	...
	public ResponseVo<Void> deleteProduct(@Valid@RequestBody Product product) {
